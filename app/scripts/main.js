...
var show_list = function(bought_list){
        ...
        $("#shopping_car").find("#items").html("<table class='table table-bordered'>" +
            ...
            "<tr id='car_coke'><td>可口可乐</td><td>3</td><td>瓶</td><td><button>-</button><span  id='coke_num'></span><button>+</button></td><td id='coke_count'> </td></tr>"+
            "<tr id='car_sprite'><td>雪碧</td><td>3</td><td>瓶</td><td><button>-</button><span  id='sprite_num'></span><button>+</button></td><td id='sprite_count'></td></tr>"+
            "<tr id='fruits'><td>" +"<h2>"+'水果'+"</h1>"+
            "</td></tr>"+
            "<tr id='fruits'><<td>名称</td><td>单价（元）</td><td>单位</td><td>数量</td><td>小计</td></tr>"+
            "<tr id='car_apple'><td>苹果</td><td>5.5</td><td>斤</td><td><button>-</button><span  id='apple_num'></span><button>+</button></td><td id='apple_count'> </td></tr>"+
            "<tr id='car_lychee'><td>荔枝</td><td>15</td><td>斤</td><td><button>-</button><span  id='lychee_num'></span><button>+</button></td><td id='lychee_count'></td></tr>"+
            "<tr id='tools'><td>" +"<h2>"+'生活用品'+"</h1>"+
            "</td></tr>"+
            "<tr id='tools'><<td>名称</td><td>单价（元）</td><td>单位</td><td>数量</td><td>小计</td></tr>"+
            "<tr id='car_battery'><td>电池</td><td>2</td><td>个</td><td><button>-</button><span  id='battery_num'></span><button>+</button></td><td id='battery_count'></td></tr>"+
            "<tr id='foods'><td>" +"<h2>"+'食品'+"</h1>"+
            "</td></tr>"+
            "<tr id='foods'><<td>名称</td><td>单价（元）</td><td>单位</td><td>数量</td><td>小计</td></tr>"+
            "<tr id='car_instant_noodles'><td>方便面</td><td>4.5</td><td>袋</td><td><button>-</button><span  id='instant_noodles_num'></span><button>+</button></td><td id='instant_noodles_count'></td></tr>"+
            "</table>");
        ...
        $("#shopping_car").find("#items").find('table').find('tr#car_coke').find('td').find('span#coke_num').text(bought_list.coke);
        $("#shopping_car").find("#items").find('table').find('tr#car_coke').find('td#coke_count').text(bought_list.coke *3);
        $("#shopping_car").find("#items").find('table').find('tr#car_sprite').find('td').find('span#sprite_num').text(bought_list.sprite);
        $("#shopping_car").find("#items").find('table').find('tr#car_sprite').find('td#sprite_count').text(bought_list.sprite*3);
        $("#shopping_car").find("#items").find('table').find('tr#car_apple').find('td').find('span#apple_num').text(bought_list.apple);
        $("#shopping_car").find("#items").find('table').find('tr#car_apple').find('td#apple_count').text(bought_list.apple*5.5);
        $("#shopping_car").find("#items").find('table').find('tr#car_lychee').find('td').find('span#lychee_num').text(bought_list.lychee);
        $("#shopping_car").find("#items").find('table').find('tr#car_lychee').find('td#lychee_count').text(bought_list.lychee*15);
        $("#shopping_car").find("#items").find('table').find('tr#car_battery').find('td').find('span#battery_num').text(bought_list.battery);
        $("#shopping_car").find("#items").find('table').find('tr#car_battery').find('td#battery_count').text(bought_list.battery*2);
        $("#shopping_car").find("#items").find('table').find('tr#car_instant_noodles').find('td').find('span#instant_noodles_num').text(bought_list.instant_noodles);
        $("#shopping_car").find("#items").find('table').find('tr#car_instant_noodles').find('td#instant_noodles_count').text(bought_list.instant_noodles*2);
